  ...
  Future<String?> openDialog() async {
    ...
    return showDialog<String>(
        ...
        builder: (context) => AlertDialog(
              title: Text(AppLocalizations.of(context)!.newlight),
              content: Column(
                children: [
                  TextField(
                    autofocus: true,
                    decoration: InputDecoration(
                        hintText: AppLocalizations.of(context)!.enteralias),
                  ...
                  DropdownButtonFormField<int>(
                      items: List.generate(
                          ...
                          (index) => DropdownMenuItem(
                              child: Text(reservedPins.keys.toList()[index]),
                              value: int.parse(reservedPins.keys
                                  .toList()[index]
                                  .split('p')
                                  .last))),
                ...
                TextButton(
                    onPressed: () async {
                      ...
                      if (controller.text == null || controller.text.isEmpty)
                        return;
                      await apiServices.addLight(
                          controller.text, widget.roomID, dropDown!);
              ...
              actions: [
                TextButton(
                    onPressed: () async {
                      if (controller.text == null || controller.text.isEmpty)
                        return;
                      await apiServices.editLightAlias(
                          widget.roomID, lightID, controller.text);
      ...
      body: StreamBuilder(
        ...
        builder: (BuildContext context, AsyncSnapshot snapshot) {
          ...
          try {
            ...
            return GridView.count(
              ...
              children: List.generate(
                ...
                (index) => GestureDetector(
                    onTap: () async => await apiServices.toggleLight(
                        widget.roomID, lightKeys[index]),
                    child: Column(
                      children: [
                        Row(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                image: AssetImage(
                                  data[lightKeys[index]]['led_status']
                                              .toString() ==
                                          '1'
                                      ? 'images/lighton.png'
                                      : 'images/lightoff.png',
                            ...
                            child: Row(
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsets.only(top: 140, left: 85),
                                  child: IconButton(
                                      onPressed: () async =>
                                          // print(lightKeys[index]),
                                          //  apiServices.removeLight(widget.roomID, lightKeys[index].toString().toLowerCase()),
                                          edit_alias_openDialog(lightKeys[index]
                                              .toString()
                                              .toLowerCase()),
                                      icon: Icon(
                                        Icons.edit,
                                        size: 30,
                                        color:
                                            Color.fromARGB(255, 131, 126, 126),
                                      )),
                                ),
                              ],
                            ),
            ...
            return Center(
              child: Text(
                AppLocalizations.of(context)!.nolight,
