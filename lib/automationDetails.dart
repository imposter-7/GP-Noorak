...
class _AutoDetails extends State<AutoDetails> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text(AppLocalizations.of(context)!.autode),
        centerTitle: true,
        backgroundColor: Colors.black,
         actions: <Widget>[
          Padding(
      ...
      StreamBuilder(
        ...
        try
        {
          ...
          if(keys.contains(AppLocalizations.of(context)!.poweron)){
             detailsData[AppLocalizations.of(context)!.poweron] = data[keys[keys.indexOf('power-on')]].toString();
          }
          ...
          return Center(child: Text(AppLocalizations.of(context)!.noauto,
