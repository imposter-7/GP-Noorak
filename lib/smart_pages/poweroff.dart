...
Future<String?> openDialog() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text(AppLocalizations.of(context)!.poweroff),
        centerTitle: true,
        backgroundColor: Colors.black,
        actions: <Widget>[
          Padding(
      ...
      Stack(
        ...
        children: [
          ...
          Padding(
            ...
            child:
               Text(AppLocalizations.of(context)!.offat
                ,
                style: TextStyle(
                    fontSize: 20,
                    color: Colors.white,
                  ...
                  ElevatedButton(
                    onPressed: (){
                      for(String id in selectedRooms){
                        apiServices.setFeature(AppLocalizations.of(context)!.poweroff ,  _selectedTime.toString(), id);
                      }
